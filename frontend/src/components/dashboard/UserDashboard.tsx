    ...
    <div className="space-y-6">
      ...
      <div className="card shadow bg-gradient-to-r from-urbano-primary to-red-600 text-white">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-red-100">{t('dashboard.welcomeMessage')}</p>
          </div>
      ...
      <div className="card shadow">
        <h2 className="font-semibold text-xl mb-4 flex items-center gap-2">
          <TrendingUp size={24} />
          {t('dashboard.user.availableActions')}
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <h3 className="font-semibold">
              {t('dashboard.quickActions.exploreCourses')}
            </h3>
            <p className="text-sm text-gray-600">
              {t('dashboard.quickActions.exploreCoursesDesc')}
            </p>
          </a>
          <a
            href="/profile"
